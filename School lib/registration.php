...
<html>
<head>
<title>Library Membership Form A Flat Responsive Widget Template :: w3layouts</title>
<!-- meta_tags-->
...
<form action="#" medthod="post">
		...
		<div class="w3l-right-grid1">
		<div class="w3l-grid1">
			<label class="text">takes member ship <span>?</span></label>
				<div class="w3l-div">
				<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
					<select class="form-contro3" required="">
			...
			<label class="text">which type of books</label>
			<div class="w3l-grid2">
				<div class="w3l-div">
					<i class="fa fa-book" aria-hidden="true"></i>
					<select class="form-contro2" required="">
...
<footer>&copy; 2018 library membership Form. All Rights Reserved | Design by <a href="http://w3layouts.com/"> WayStudio</a></footer>

<!-- Default-JavaScript --> <script type="text/javascript" src="script/jquery-2.1.4.min.js"></script>
